        ...
        <nav class="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
            <div class="me-5 lg:me-0 lg:hidden flex items-center">
              ...
              <span class="relative flex">
                ...
                <span class="sr-only">Notification</span>
                        ...
                        <div
                            ...
                            <div id="hs-pmn-pro" class="hidden" role="tabpanel" aria-labelledby="hs-pmn-item-pro">
                                ...
                                <div class="p-3 flex flex-wrap justify-between items-center gap-3">
                                    ...
                                    <div class="ms-auto">
                                        <a class="group py-2 px-2.5 rounded-md flex items-center gap-x-1 text-[13px] bg-gray-800 text-white hover:bg-gray-900 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-gray-900 dark:bg-white dark:hover:bg-neutral-200 dark:focus:bg-neutral-200 dark:text-neutral-800"
                                           href="../pro/pricing.html">
                                            Purchase
                                            <svg
                                                class="hidden md:inline-block shrink-0 size-3.5 group-hover:translate-x-0.5 transition"
                                ...
                                <div
                                    ...
                                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                        <!-- Link -->
                                        <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                           href="../pro/dashboard/index.html">
                                            <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                                 src="../assets/img/demo-previews/img1.webp" alt="Main Page">
                                            <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                                 src="../assets/img/demo-previews-dark/img1.webp" alt="Main Page">
                                        ...
                                        <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                           href="../pro/cms/index.html">
                                            <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                                 src="../assets/img/demo-previews/img55.webp" alt="Main Page">
                                            <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                                 src="../assets/img/demo-previews-dark/img55.webp" alt="Main Page">
        					    ...
        					    <span class=" py-0.5 px-2 inline-flex items-center gap-x-1.5 text-xs font-medium
                                                 bg-emerald-100 text-emerald-800 rounded-full dark:bg-emerald-900
                                    ...
                                    <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                       href="../pro/ai-chat/index.html">
                                        <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                             src="../assets/img/demo-previews/img58.webp" alt="Main Page">
                                        <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                             src="../assets/img/demo-previews-dark/img58.webp" alt="Main Page">
                                ...
                                <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                   href="../pro/video-call/index.html">
                                    <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                         src="../assets/img/demo-previews/img61.webp" alt="Main Page">
                                    <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                         src="../assets/img/demo-previews-dark/img61.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/startup/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img32.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img32.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/payment/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img8.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img8.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/chat/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img16.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img16.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/shop/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img21.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img21.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/ecommerce/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img4.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img4.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/agency/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img46.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img46.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/crm/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img11.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img11.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/workspace/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img18.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img18.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/analytics/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img9.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img9.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/calendars/day.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img14.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img14.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/smart-home/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img35.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img35.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/coffee-shop/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img52.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img52.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/inbox/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img26.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img26.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/project/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img10.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img10.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/shop-marketplace/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img29.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img29.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/personal/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img49.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img49.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../pro/files/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews/img12.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/demo-previews-dark/img12.webp" alt="Main Page">
                    ...
                    <div class="p-3 flex flex-wrap justify-center items-center gap-0.5">
                        <div
                            ...
                            <a class="group flex items-center gap-x-1.5 py-1.5 px-2 rounded-md text-[13px] text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                               href="../pro/index.html">
                                Main page
                                <svg class="shrink-0 size-3.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <path
                                        ...
                                        d="M5 12h14"/>
                                    <path class="lg:-translate-x-1.5 lg:group-hover:translate-x-0 lg:transition"
                                          d="m12 5 7 7-7 7"/>
                                </svg>
                            </a>
                        </div>
                ...
                <div id="hs-pmn-free" class="" role="tabpanel" aria-labelledby="hs-pmn-item-free">
                    ...
                    <div class="p-3 flex flex-wrap justify-between items-center gap-3">
                        <span
                            class="block font-semibold text-sm text-gray-800 dark:text-neutral-200">Templates (5)</span>
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../templates/agency/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/template-previews/img1.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/template-previews-dark/img1.webp" alt="Main Page">
                            ...
                            <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                               href="../templates/ai-chat/index.html">
                                <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                     src="../assets/img/template-previews/img4.webp" alt="Main Page">
                                <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                     src="../assets/img/template-previews-dark/img4.webp" alt="Main Page">
                                ...
                                <div class="absolute -top-px end-[3px]'>
        	            <span class=" py-0.5 px-2 inline-flex items-center gap-x-1.5 text-xs font-medium bg-emerald-100
                                     text-emerald-800 rounded-full dark:bg-emerald-900 dark:text-emerald-500
                                ">New</span>
                        </div>
                        </a>
                        <!-- End Link -->
                        ...
                        <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                           href="../templates/cms/index.html">
                            <img class="dark:hidden w-28 rounded-lg shadow-xs"
                                 src="../assets/img/template-previews/img5.webp" alt="Main Page">
                            <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                                 src="../assets/img/template-previews-dark/img5.webp" alt="Main Page">
                    ...
                    <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                       href="../templates/coffee-shop/index.html">
                        <img class="dark:hidden w-28 rounded-lg shadow-xs"
                             ...
                             alt="Main Page">
                        <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                             src="../assets/img/template-previews-dark/img2.webp" alt="Main Page">
                    ...
                    <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                       href="../templates/personal/index.html">
                        <img class="dark:hidden w-28 rounded-lg shadow-xs"
                             ...
                             alt="Main Page">
                        <img class="hidden dark:block w-28 rounded-lg shadow-xs"
                             src="../assets/img/template-previews-dark/img3.webp" alt="Main Page">
            ...
            <div class="w-full flex items-center justify-end ms-auto md:justify-between gap-x-1 md:gap-x-3">
              ...
              <svg class="shrink-0 size-3 text-gray-400 dark:text-white/60" xmlns="http://www.w3.org/2000/svg"
                   ...
                   stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
            </span>
                        ...
                        <span
                          ...
                          Active
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                class="text-sm text-gray-500 dark:text-neutral-500">28 Dec, 12:12</span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                        ...
                        <span
                          ...
                          Warning
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                class="text-sm text-gray-500 dark:text-neutral-500">20 Dec, 09:27</span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-1.5">
                            ...
                            <span class="font-medium text-sm text-gray-800 dark:text-neutral-200">A</span>
                                    ...
                                    <td class="h-px w-72 whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            ...
                                            <span
                                                class="block text-sm text-gray-500 dark:text-neutral-500">IT department</span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                        <span
                          ...
                          Active
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                class="text-sm text-gray-500 dark:text-neutral-500">18 Dec, 15:20</span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-1.5">
                            ...
                            <span class="font-medium text-sm text-gray-800 dark:text-neutral-200">D</span>
                                    ...
                                    <td class="h-px w-72 whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            ...
                                            <span
                                                class="block text-sm text-gray-500 dark:text-neutral-500">Mobile app</span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                        <span
                          ...
                          Danger
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                class="text-sm text-gray-500 dark:text-neutral-500">15 Dec, 14:41</span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-1.5">
                        ...
                        <span
                          ...
                          Active
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                class="text-sm text-gray-500 dark:text-neutral-500">11 Dec, 18:51</span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-1.5">
                        ...
                        <span
                          ...
                          <span
                            ...
                            <span class="font-medium text-sm text-gray-800 dark:text-neutral-200">I</span>
                                                ...
                                                <div class="grow">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">Inna Ivy</span>
