<section class="container-lg">
    ...
    <!-- Hero -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 min-h-[100vh]">
        <!-- Grid -->
        <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
                ...
                <p class="mt-3 text-lg text-gray-800">Hand-picked professionals and expertly
                ...
                <div class="mt-7 grid gap-3 w-full sm:inline-flex">
                    ...
                    <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
                       href="#">
                        Contact sales team
                    </a>
                </div>
                ...
                <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                    ...
                    <div class="py-5">
                        <div class="flex gap-x-1">
                            <svg class="size-4 text-gray-800" width="51" height="51"
            ...
            <div class="relative ms-4">
                <img class="w-full rounded-md"
                     ...
                     alt="Hero Image">
                <div
                    class="absolute inset-0 -z-1 bg-linear-to-tr from-gray-200 via-white/0 to-white/0 size-full rounded-md mt-4 -mb-4 me-4 -ms-4 lg:mt-6 lg:-mb-6 lg:me-6 lg:-ms-6"></div>
    ...
    <!-- Icon Blocks -->
    <div class="px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto bg-zinc-100">
        <div class="max-w-7xl mx-auto grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-2">
            <!-- Icon Block -->
            <a class="group flex flex-col justify-center hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 rounded-xl p-4 md:p-7 hover:scale-105 ease-in-out duration-200"
               href="#">
                ...
                <div class="mt-5">
                    <h3 class="group-hover:text-gray-600 text-lg font-semibold text-gray-800">
                        Responsive</h3>
                    <p class="mt-1 text-gray-600">Responsive, and mobile-first project on the
                        web</p>
                    <span
            ...
            <a class="group flex flex-col justify-center hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 rounded-xl p-4 md:p-7 hover:scale-105 ease-in-out duration-200"
               href="#">
                ...
                <div class="mt-5">
                    <h3 class="group-hover:text-gray-600 text-lg font-semibold text-gray-800">
                        Customizable</h3>
                    <p class="mt-1 text-gray-600">Components are easily customized and
                        extendable</p>
                    <span
                        class="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline group-focus:underline font-medium">
          Learn more
            ...
            <a class="group flex flex-col justify-center hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 rounded-xl p-4 md:p-7 hover:scale-105 ease-in-out duration-200"
               href="#">
                ...
                <div class="mt-5">
                    <h3 class="group-hover:text-gray-600 text-lg font-semibold text-gray-800">
                        Documentation</h3>
                    <p class="mt-1 text-gray-600">Every component and plugin is well
                        documented</p>
                    <span
                        class="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline group-focus:underline font-medium">
          Learn more
    ...
    <!-- Card Blog -->
    <div class="max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-14 mx-auto min-h-[100vh]">
        <!-- Title -->
        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
            <h2 class="text-2xl font-bold md:text-4xl md:leading-tight">Insights</h2>
            <p class="mt-1 text-gray-600">Stay in the know with insights from industry
                experts.</p>
        </div>
        <!-- End Title -->
